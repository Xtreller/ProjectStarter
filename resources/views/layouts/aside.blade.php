                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="/admin/dashboard"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Дашборд</span>
                        </a>
                    </li>

                    {{-- @foreach ($asideLinks as $aside_link)
                        @if (count($aside_link->childs) == 0)
                            <li>
                                <a href="/orchestra/{{ $aside_link->slug }}"
                                   class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                    <!-- <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg> -->
                                    {!! $aside_link->icon !!}
                                    <span class="ml-3" sidebar-toggle-item>{{ $aside_link->name }}</span>
                                </a>
                            </li>
                        @else
                            <li>
                  ...
                  <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"></path>
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                          sidebar-toggle-item>{{ $aside_link->name }}</span>
                                ...
                                <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                                    @foreach ($aside_link->childs as $child)
                                        <li>
                                            <a href="{{ route($child->slug) }}"
                                               class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">{{ $child->name }}</a>
                                        </li>
                                    @endforeach
                                    <!-- <li>
